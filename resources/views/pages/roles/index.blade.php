                        ...
                        <div class="row gy-4">
                            <table class="table" id="dataTbl">
                                ...
                                <tr>
                                    <td>{{ $loop->index+1 }}</td>                                    
                                    <td>{{ $item->name }}</td>                     
                                      <td><button type="button" class="btn btn-sm btn-primary waves-effect waves-light"><a href="{{ route('roles.edit',$item->id) }}"><i class="fe fe-edit" style="color: #fff"></i></a></button>| <button type="button" data-bs-toggle="modal" data-bs-target="#myModal{{ $item->id }}" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fe fe-trash-2"></i></button>                                      
                                    </td>
                                    <!-- Default Modals -->
